...
# user settings
swe_gz_folders = [
    r'/Projects/Tian_workspace/rdhm_ueb_modeling/McPhee_MPHC2/snow17_best/SAC_out/we',  # snow17 swe xmrg .gz folder
    r'/Projects/Tian_workspace/rdhm_ueb_modeling/McPhee_MPHC2/MPHC2/MPHC2_create_1d/SAC_out//uebW/',  # ueb swe xmrg .gz folder
]
grid_time_step = [
