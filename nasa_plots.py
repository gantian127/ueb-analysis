...
plot_2d_grid(x_name='x',
             ...
             time_index=1000,
             slice_obj=None,
             title='Precipitation in {} {} '.format(watershed, year),
             xlabel='X coordinate ',
             ylabel='Y coordinate',
             figsize=(10, 8),
             save_as='2d_precipitation_{}_{}.png'.format(watershed, year))
...
plot_2d_grid(x_name='x',
             ...
             time_index=1000,
             slice_obj=None,
             title='SWE(m) in {} {} '.format(watershed, year),
             xlabel='X coordinate ',
             ylabel='Y coordinate',
             figsize=(10, 8),
             save_as=None)
...
plot_2d_animation(file_path='prcp0.nc', x_name='x', y_name='y',
                  ...
                  interval=300,
                  title='Precipitation(m/hr) in {} {}'.format(watershed, year),
                  xlabel='x', ylabel='y',
                  cmap='viridis',
                  repeat=True,
                  )
